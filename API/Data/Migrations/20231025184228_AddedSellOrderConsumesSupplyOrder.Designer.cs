...
namespace HospitalApp.Data.Migrations
{
    ...
    [Migration("20231025184228_AddedSellOrderConsumesSupplyOrder")]
    partial class AddedSellOrderConsumesSupplyOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Models.Entities.Clinic", b =>
                {
                    ...
                    b.Property<int>("ClinicSpecialityId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Models.Entities.Clinic", b =>
                {
                    ...
                    b.HasOne("webapi.Entities.AppUser", "Doctor")
                        .WithOne()
                        .HasForeignKey("API.Models.Entities.Clinic", "DoctorId");
